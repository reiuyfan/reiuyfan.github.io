...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4e0a903e46cc818945eab64fc6eb1bcbcbd7ecacc0c5cd85013d2faffde40990.js',function(){input.required=false;search();});}
